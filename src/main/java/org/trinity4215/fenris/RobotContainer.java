...
public class RobotContainer {
    ...
    private final JoystickButton armUpButton = new JoystickButton(xboxController, xboxPorts.select());
    ...
    private ParallelRaceGroup armBitDown = new StartEndCommand(
        ...
        shootyBits
    ).withTimeout(ShootyBitsConstants.kArmDownTime).until(() -> shootyBits.getArmLimit()); 
